...
You can run the CLI with an example program by invoking `make run` at the bin folder.

## Run

If you type `help` as the first argument of the CLI, you will receive the guide of the program.
